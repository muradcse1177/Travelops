<head>
    ...
    <style>
        ...
        .nav-treeview {
            ...
            margin-left: 5px;             /* gap from parent */
            padding-left: 10px;            /* text spacing */
            background: rgba(198, 24, 24, 0.03);  /* হালকা ধূসর ব্যাকগ্রাউন্ড */
            border-radius: 4px;            /* কোণা একটু গোল করতে চাইলে */
        }
