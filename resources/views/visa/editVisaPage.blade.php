                    ...
                    <div class="col-md-12">
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">Visa Accounts</h3>
                            ...
                            <div class="card-body" style="display: block;">
                                {{ Form::open(array('url' => 'editVisa',  'method' => 'post' ,'class' =>'form-horizontal', 'files' => true)) }}
                                {{ csrf_field() }}
                                <div class="card-body row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label>Date</label>
                                            <input type="date" class="form-control" id="date" name="date" value="{{ $visa->date }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12 newPassenger" style="margin-left: 0px;">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="p_details" name="p_details" rows="5" placeholder="Write Payments Detail..." required>{{ old('v_p_details', $visa->v_p_details ?? '') }}</textarea>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="vendor_p_details" name="vendor_p_details" rows="5" placeholder="Write Vendor Payment Details..." required>{{ old('vendor_p_details', $visa->vendor_p_details ?? '') }}</textarea>
                                    </div>
