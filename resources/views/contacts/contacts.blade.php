                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2bs4 group" name="purpose" id="purpose" style="width: 100%;" required>
                                                    ...
                                                    <option value="Bank Solvency">Course</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-danger">
                            ...
                            <div class="card-body" style="display: none;">
                                {{ Form::open(array('url' => 'createNewContactsDetails',  'method' => 'post', 'enctype' => 'multipart/form-data', 'class' =>'form-horizontal')) }}
                                {{ csrf_field() }}
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-warning float-right">Import</button>
                                </div>
                                {{ Form::close() }}
                            </div>
                        </div>
