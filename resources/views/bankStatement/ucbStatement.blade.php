                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="s_date" name="s_date" placeholder="01-01-2023" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label>Statement End Date</label>
                                            <input type="date" class="form-control" id="e_date" name="e_date" placeholder="01-07-2023" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label>Forward Balance</label>
                                            <input type="number" class="form-control" step="0.01" id="f_balance" name="f_balance" placeholder="Enter Forward Balance" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
