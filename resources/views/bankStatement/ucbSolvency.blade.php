                                ...
                                <div class="card-body row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="date" name="date" placeholder="09 July 2023"  required>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="e_date" name="e_date" placeholder="08 July 2023" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="branch_address" name="branch_address" placeholder="Enter Branch Address" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label>Branch Phone</label>
                                            <input type="text" class="form-control" id="branch_phone" name="branch_phone" placeholder="Enter Branch Phone" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label>Branch Email</label>
                                            <input type="text" class="form-control" id="branch_email" name="branch_email" placeholder="Enter Branch Email" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label>Swift Code</label>
                                            <input type="text" class="form-control" id="swift_code" name="swift_code" placeholder="Enter Swift Code" required>
                                        </div>
                                    </div>
                                </div>
