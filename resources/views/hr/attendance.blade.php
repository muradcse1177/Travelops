                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="" class="table table-bordered table-hover">
                                        ...
                                        @foreach($atts as $att)
                                            @php
                                                $result = DB::table('users')->where('id',$att->user_id)->first();
                                                $isToday = \Carbon\Carbon::today(config('app.timezone'))->toDateString() === (string)$att->date;
                                                $canRemark = ( (!empty($att->late) || !empty($att->early_exit)) && empty($att->remarks) && $isToday );
                                            @endphp
                                            <tr>
                                                <td>{{$i}}</td>
                                                <?php
                            ...
                            <!-- /.card-body -->
                            <div class="modal fade" id="remarkModal" tabindex="-1" role="dialog" aria-labelledby="remarkLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <form method="POST" action="{{ route('attendance.remark') }}" class="modal-content">
                                        @csrf
                                        <input type="hidden" name="id" id="remarkRowId">
                                        <div class="modal-header bg-info">
                                            <h5 class="modal-title" id="remarkLabel">Save Remark</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group mb-0">
                                                <label>Remarks <small class="text-muted">(max 500 chars)</small></label>
                                                <input type="text" name="remarks" id="remarkInput" class="form-control" maxlength="255" required>
                                            </div>
                                        </div>
...
@section('js')
    <script>
        ...
        $('#remarkModal').on('show.bs.modal', function (event) {
            ...
            $('#remarkRowId').val(id);
            $('#remarkInput').val(remarks).trigger('focus');
        });
    </script>
@endsection
