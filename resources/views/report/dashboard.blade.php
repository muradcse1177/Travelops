                ...
                <div class="row">
                    @php
                        $cards = [
                            ...
                            ['title' => 'Service', 'prefix' => 'service', 'url' => 'newServicePackage'],
                        ];

                        // Totals (Gross)
                        $totalMonthlySale =
                            $monthly_sale_air_ticket +
                            $monthly_sale_visa +
                            $monthly_sale_tour +
                            $monthly_sale_hotel +
                            $monthly_sale_hajj +
                            $monthly_sale_service;

                        $grossMonthlyProfit =
                            ($monthly_sale_air_ticket - $monthly_a_sale_air_ticket) +
                            ($monthly_sale_visa - $monthly_a_sale_visa) +
                            ($monthly_sale_tour - $monthly_a_sale_tour) +
                            ($monthly_sale_hotel - $monthly_a_sale_hotel) +
                            ($monthly_sale_hajj - $monthly_a_sale_hajj) +
                            ($monthly_sale_service - $monthly_a_sale_service);
                    @endphp
                    ...
                    @foreach($cards as $card)
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-success">
                                <div class="inner">
                                    <h4>{{ number_format(${"monthly_sale_{$card['prefix']}"},2) }}</h4>
                                    <p>Monthly {{ $card['title'] }} Sale</p>
                                </div>
                                <div class="icon"><i class="fas fa-chart-line"></i></div>
                                <a href="{{ url($card['url']) }}" class="small-box-footer">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h4>{{ number_format(${"daily_sale_{$card['prefix']}"},2) }}</h4>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h4>
                                        {{ number_format(${"daily_sale_{$card['prefix']}"} - ${"daily_a_sale_{$card['prefix']}"},2) }}
                                    </h4>
                                    <p>Today {{ $card['title'] }} Gross Profit</p>
                                </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-danger">
                                <div class="inner">
                                    <h4>
                                        {{ number_format(${"monthly_sale_{$card['prefix']}"} - ${"monthly_a_sale_{$card['prefix']}"},2) }}
                                    </h4>
                                    <p>Monthly {{ $card['title'] }} Gross Profit</p>
                                </div>
                                <div class="icon"><i class="fas fa-dollar-sign"></i></div>
                                <a href="{{ url($card['url']) }}" class="small-box-footer">
                                    More info <i class="fas fa-arrow-circle-right"></i>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-dark">
                            <div class="inner">
                                <h4>{{ number_format($totalMonthlySale,2) }}</h4>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-dark">
                            <div class="inner">
                                <h4>{{ number_format($grossMonthlyProfit,2) }}</h4>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-dark">
                            <div class="inner">
                                <h4>{{ number_format($daily_expense,2) }}</h4>
                                <p>Daily Expense</p>
                            </div>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-dark">
                            <div class="inner">
                                <h4>{{ number_format($monthly_expense,2) }}</h4>
                                <p>Monthly Expense</p>
                            </div>
                            <div class="icon"><i class="fas fa-wallet"></i></div>
                        </div>
