                                            ...
                                            <div class="form-group hdd-arrow mb-0">
                                                <select class="goingto form-control fw-bold" name="country">
                                                    ...
                                                    @foreach($t_country as $country)
                                                        <option value="{{$country->name}}" {{ ($country->name == ($_GET['country'] ?? '')) ? 'selected':'' }}>{{$country->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
        ...
        <section class="gray-simple">
            <div class="container">
                <div class="row justify-content-between gy-4 gx-xl-4 gx-lg-3 gx-md-3 gx-4">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <!-- WRAPPER ONLY (NO DESIGN CHANGE) -->
                        <div class="row justify-content-center gy-4 gx-xl-4 gx-lg-3 gx-md-3 gx-4" id="data-wrapper">
...
let page = 1;
let lastPage = {{ $t_package->lastPage() ?? 1 }};
let loading = false;
...
function loadMore() {
    ...
    fetch("?page=" + page)
        ...
        .then(html => {
            ...
            let items = doc.querySelectorAll("#data-wrapper .col-xl-4");
        ...
        .catch(() => {
            loading = false;
            hideLoader();   // HIDE LOADER EVEN IF ERROR
        });
}
