...
@section('css')
    ...
    /* ===============================
        ...
        .gallery-card {
            ...
            border-radius: 26px;
            background: linear-gradient(180deg, #c7cdda, #ffffff);
            padding: 14px;                 /* 🔥 image & card gap */
        }
            ...
            <div class="container position-relative">
                <div class="row">
                    <div class="col-12 text-center text-white">
                        <h3 class="fw-bold text-white">Tour Package:  <span style="color: #f1bb09">{{@$package->p_name}}</span></h3>
                        <p class="mb-0 text-white opacity-90">
                            Grab your package safely & quickly
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        ...
                        <div class="card gallery-card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                            @php
                                ...
                                $tnt = json_decode($package->tnt); $totalPhotos = count($m_photo);
                            @endphp
