                            ...
                            <div class="card-body" style="display: none;">
                                <div class="row">
                                    <div class="col-sm-12 text-right mb-2">
                                        <!-- Hidden File Input -->
                                        <input type="file" id="passportScanInput" accept="image/*" style="display:none">

                                        <!-- Icon -->
                                        <i class="fas fa-passport" id="scanPassportBtn"
                                           style="font-size:28px;color:#007bff;cursor:pointer;"
                                           title="Scan Passport"></i>
                                    </div>
                                </div>
