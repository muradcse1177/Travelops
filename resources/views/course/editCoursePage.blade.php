                                ...
                                <form action="{{ url('updateCourse') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="number" name="seat_remain" class="form-control" value="{{ $course->seat_remain }}" required>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <label>Next Approximate Date</label>
                                            <input type="date" name="app_date" class="form-control" value="{{ $course->app_date }}" required>
                                        </div>
                                    ...
                                    <div class="card card-info mt-3">
                                        <div class="card-header"><h3 class="card-title">Course Variations</h3></div>
                                        <div class="card-body">
                                            @php
                                            ...
                                            @foreach($titles as $key=>$label)
                                                <div class="row border rounded p-2 mb-2">
                                                    <div class="col-sm-3">
                                                        ...
                                                        <input type="hidden" name="variation_title[]" value="{{ $key }}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <label>Price</label>
                                                        <input type="number" class="form-control" name="{{ $key }}_price" value="{{ $variations[$key]['price'] ?? '' }}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <label>Discounted Price</label>
                                                        <input type="number" class="form-control" name="{{ $key }}_d_price" value="{{ $variations[$key]['d_price'] ?? '' }}">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <label>Status</label>
                                                        <select class="form-control" name="{{ $key }}_status">
                                                            <option value="1" {{ isset($variations[$key]['status']) && $variations[$key]['status']==1 ? 'selected':'' }}>Active</option>
                                                            <option value="0" {{ isset($variations[$key]['status']) && $variations[$key]['status']==0 ? 'selected':'' }}>Inactive</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            @endforeach
