...
//            DB::commit();
    ...
    public function callback(Request $request)
    {
        ...
        if (
            ...
            session()->flash('fb_event_id', $invoiceId);     // SAME event_id for pixel + CAPI
            session()->flash('fb_event_value', $order->amount);
            
            //app(\App\Http\Controllers\paymentController::class)->coursePaymentRedirect($order);
            app(\App\Http\Controllers\universalPaymentController::class)->handlePostPayment($order);
